 ...
 * @generated from message spec.BufValidateSimple
 */
export type BufValidateSimpleValid = Message<"spec.BufValidateSimple"> & {
  /**
   * @generated from field: string description = 2;
   */
  description: string;
 ...
 */
export const BufValidateSimpleSchema: GenMessage<BufValidateSimple, {validType: BufValidateSimpleValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateMultiple
 */
export type BufValidateMultipleValid = Message<"spec.BufValidateMultiple"> & {
  /**
   * @generated from field: string title = 3;
   */
  title: string;
 ...
 */
export const BufValidateMultipleSchema: GenMessage<BufValidateMultiple, {validType: BufValidateMultipleValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateNotHas
 */
export type BufValidateNotHasValid = Message<"spec.BufValidateNotHas"> & {
  /**
   * @generated from field: string other_field = 2;
   */
  otherField: string;
 ...
 */
export const BufValidateNotHasSchema: GenMessage<BufValidateNotHas, {validType: BufValidateNotHasValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateNested
 */
export type BufValidateNestedValid = Message<"spec.BufValidateNested"> & {
  /**
   * @generated from field: spec.NestedChild nested = 1;
   */
 ...
 */
export const BufValidateNestedSchema: GenMessage<BufValidateNested, {validType: BufValidateNestedValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateCombined
 */
export type BufValidateCombinedValid = Message<"spec.BufValidateCombined"> & {
  /**
   * @generated from field: string field3 = 3;
   */
  field3: string;
 ...
 */
export const BufValidateCombinedSchema: GenMessage<BufValidateCombined, {validType: BufValidateCombinedValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateSnakeCase
 */
export type BufValidateSnakeCaseValid = Message<"spec.BufValidateSnakeCase"> & {
  /**
   * @generated from field: string first_name = 2;
   */
  firstName: string;
 ...
 */
export const BufValidateSnakeCaseSchema: GenMessage<BufValidateSnakeCase, {validType: BufValidateSnakeCaseValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateNoCel
 */
export type BufValidateNoCelValid = Message<"spec.BufValidateNoCel"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
 ...
 */
export const BufValidateNoCelSchema: GenMessage<BufValidateNoCel, {validType: BufValidateNoCelValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateMultipleNested
 */
export type BufValidateMultipleNestedValid = Message<"spec.BufValidateMultipleNested"> & {
  /**
   * @generated from field: spec.NestedChild child1 = 1;
   */
 ...
 */
export const BufValidateMultipleNestedSchema: GenMessage<BufValidateMultipleNested, {validType: BufValidateMultipleNestedValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateWithRequired
 */
export type BufValidateWithRequiredValid = Message<"spec.BufValidateWithRequired"> & {
  /**
   * @generated from field: string required_field = 2;
   */
  requiredField: string;
 ...
 */
export const BufValidateWithRequiredSchema: GenMessage<BufValidateWithRequired, {validType: BufValidateWithRequiredValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateOr
 */
export type BufValidateOrValid = Message<"spec.BufValidateOr"> & {
  /**
   * @generated from field: string field1 = 1;
   */
  field1: string;
 ...
 */
export const BufValidateOrSchema: GenMessage<BufValidateOr, {validType: BufValidateOrValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateWithRepeated
 */
export type BufValidateWithRepeatedValid = Message<"spec.BufValidateWithRepeated"> & {
  /**
   * @generated from field: repeated string list_field = 2;
   */
  listField: string[];
 ...
 */
export const BufValidateWithRepeatedSchema: GenMessage<BufValidateWithRepeated, {validType: BufValidateWithRepeatedValid}> = /*@__PURE__*/
 ...
 * @generated from message spec.BufValidateReference
 */
export type BufValidateReferenceValid = Message<"spec.BufValidateReference"> & {
  /**
   * @generated from field: spec.BufValidateSimple simple = 1;
   */
 ...
 */
export const BufValidateReferenceSchema: GenMessage<BufValidateReference, {validType: BufValidateReferenceValid}> = /*@__PURE__*/
